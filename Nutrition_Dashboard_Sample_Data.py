...
df = pd.read_csv("https://raw.githubusercontent.com/eleanorb96/cse314_group-project/bhoshaw/updated_mcd_data.csv")
    ...
    html.Div([
        html.Div([
            ...
            dbc.Table([
                ...
                html.Tr([html.Td("Total Fat:"), html.Td(id='fat-amount'), html.Td(id="daily-fats")]),
                html.Tr([html.Td("Saturated Fat:"), html.Td(id='satfat-amount'), html.Td(id="daily-satfat")]),
                html.Tr([html.Td("Trans Fat:"), html.Td(id='tranfat-amount'), html.Td("")]),
                html.Tr([html.Td("Cholesterol:"), html.Td(id='chol-amount'), html.Td(id="daily-chol")]),
                html.Tr([html.Td("Sodium:"), html.Td(id='sodium-amount'), html.Td(id="daily-sodium")]),
                html.Tr([html.Td("Total Carbohydrate:"), html.Td(id='carb-amount'), html.Td(id="daily-carb")]),
                html.Tr([html.Td("Dietary Fiber:"), html.Td(id='fiber-amount'), html.Td(id="daily-fiber")]),
                html.Tr([html.Td("Sugars:"), html.Td(id='sugar-amount'), html.Td("")]),
                html.Tr([html.Td("Protein:"), html.Td(id='protein-amount'), html.Td(id="daily-protein")]),
                html.Tr([html.Td("Vitamin A:"), html.Td(""), html.Td(id="daily-A")]),
                html.Tr([html.Td("Vitamin C:"), html.Td(""), html.Td(id="daily-C")]),
                html.Tr([html.Td("Calcium:"), html.Td(""), html.Td(id="daily-calcium")]),
                html.Tr([html.Td("Iron:"), html.Td(""), html.Td(id="daily-iron")]),
            ]),
        ...
        html.Div([
            ...
            dbc.Table([
                html.Thead(html.Tr([html.Th("Nutrition Fact"), html.Th("Amount"), html.Th("Daily Value")])),
                html.Tr([html.Td("Total Calories:"), html.Td(id='calorie-amount2'), html.Td(id="daily-calories2")]),
                html.Tr([html.Td("Total Fat:"), html.Td(id='fat-amount2'), html.Td(id="daily-fats2")]),
                html.Tr([html.Td("Saturated Fat:"), html.Td(id='satfat-amount2'), html.Td(id="daily-satfat2")]),
                html.Tr([html.Td("Trans Fat:"), html.Td(id='tranfat-amount2'), html.Td("")]),
                html.Tr([html.Td("Cholesterol:"), html.Td(id='chol-amount2'), html.Td(id="daily-chol2")]),
                html.Tr([html.Td("Sodium:"), html.Td(id='sodium-amount2'), html.Td(id="daily-sodium2")]),
                html.Tr([html.Td("Total Carbohydrate:"), html.Td(id='carb-amount2'), html.Td(id="daily-carb2")]),
                html.Tr([html.Td("Dietary Fiber:"), html.Td(id='fiber-amount2'), html.Td(id="daily-fiber2")]),
                html.Tr([html.Td("Sugars:"), html.Td(id='sugar-amount2'), html.Td("")]),
                html.Tr([html.Td("Protein:"), html.Td(id='protein-amount2'), html.Td(id="daily-protein2")]),
                html.Tr([html.Td("Vitamin A:"), html.Td(""), html.Td(id="daily-A2")]),
                html.Tr([html.Td("Vitamin C:"), html.Td(""), html.Td(id="daily-C2")]),
                html.Tr([html.Td("Calcium:"), html.Td(""), html.Td(id="daily-calcium2")]),
                html.Tr([html.Td("Iron:"), html.Td(""), html.Td(id="daily-iron2")]),
            ]),
        ], style={'padding': 10, 'flex': 1}),
...
def update_graph(input_brand, input_feature, food_choices):
    ...
    if input_feature == "Calories":
        ...
        newnames = {'nf_total_fat':'Fat', 'nf_total_carbohydrate': 'Carbs', "nf_protein" : "Protein"}
